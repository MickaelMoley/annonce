 ...
 */
final class Version20191231113610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE mileage mileage VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE mileage mileage JSON NOT NULL');
    }
}
